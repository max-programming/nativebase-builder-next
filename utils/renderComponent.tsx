...
export const renderComponent = (
  ...
  switch (draggableId) {
    ...
    case 'Hidden':
      ...
      break;
    case 'Fab':
      addComponent(<Box height="200" w="250" shadow="2" rounded="lg" _dark={{
        bg: "coolGray.200:alpha.20"
      }} _light={{
        bg: "coolGray.200:alpha.20"
      }}>
        <Fab renderInPortal={false} shadow={2} size="sm" icon={<IoReload color="white" name="plus" size="20" />} />
      </Box>);
      break;
    case 'Slider':
      addComponent(
    ...
    case 'Radio':
      addComponent(
        <Radio.Group name="myRadioGroup" accessibilityLabel="favorite number" value={"one"}>
    ...
    case 'SectionList':
      addComponent(
        <SectionList maxW="300" w="100%" mb="4" sections={sectionListData} keyExtractor={(item, index) => item + index} renderItem={({
          item
        }) => <Center py="4" bg={item}>
            {item.split(".")[1]}
